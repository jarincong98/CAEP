...
residual = NaN(14, 1);
    residual(1) = (y(18)) - (0.5*y(4)+params(1)*0.5*y(32)+y(15)*T(2));
    residual(2) = (y(15)) - (T(1)*(y(20)-y(32)-y(22))+1/(1+params(15))*y(29)+params(15)/(1+params(15))*y(1));
    residual(3) = (y(22)) - (params(12)+params(2)*(y(23)-y(9)));
    residual(4) = (y(20)) - (params(14)*y(6)+(1-params(14))*(y(18)*params(8)+y(15)*params(9))+y(24));
