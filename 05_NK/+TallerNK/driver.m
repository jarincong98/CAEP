...
M_.mapping.pi.eqidx = [1 4 10 14 ];
M_.mapping.n.eqidx = [9 ];
M_.mapping.i.eqidx = [4 10 11 ];
M_.mapping.r.eqidx = [2 10 12 ];
...
M_.block_structure.block(2).equation = [ 2 10 1 4];
M_.block_structure.block(2).variable = [ 7 6 1 4];
M_.block_structure.block(2).is_linear = true;
M_.block_structure.block(2).NNZDerivatives = 12;
M_.block_structure.block(2).bytecode_jacob_cols_to_sparse = [1 2 3 4 0 0 ];
...
M_.block_structure.block(2).g1_sparse_rowval = int32([1 2 2 4 1 3 4 3 4 ]);
...
M_.block_structure.variable_reordered = [ 10 9 3 8 14 7 6 1 4 12 2 13 11 5];
M_.block_structure.equation_reordered = [ 5 6 8 3 13 2 10 1 4 14 7 12 11 9];
...
M_.dynamic_g1_sparse_rowval = int32([3 6 8 9 5 1 2 4 7 7 9 7 8 1 4 14 9 4 10 11 2 10 12 2 3 13 3 6 4 5 11 14 12 13 2 1 10 6 5 ]);
M_.dynamic_g1_sparse_colval = int32([9 9 9 9 10 15 15 15 15 16 16 17 17 18 18 18 19 20 20 20 21 21 21 22 22 22 23 23 24 24 25 26 27 28 29 32 32 43 44 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 1 1 1 1 1 1 1 5 6 6 6 6 6 10 12 14 17 18 21 24 27 29 31 32 33 34 35 36 36 36 38 38 38 38 38 38 38 38 38 38 38 39 40 ]);
...
M_.block_structure_stat.block(5).equation = [ 1 2 4 10];
M_.block_structure_stat.block(5).variable = [ 1 7 4 6];
...
M_.block_structure_stat.block(6).equation = [ 14];
...
M_.block_structure_stat.variable_reordered = [ 8 10 9 3 14 1 7 4 6 12 2 13 11 5];
...
M_.block_structure_stat.block(5).g1_sparse_rowval = int32([1 3 2 4 1 3 4 3 4 ]);
M_.block_structure_stat.block(5).g1_sparse_colval = int32([1 1 2 2 3 3 3 4 4 ]);
M_.block_structure_stat.block(5).g1_sparse_colptr = int32([1 3 5 8 10 ]);
...
M_.static_g1_sparse_rowval = int32([1 4 7 7 9 7 8 1 4 10 14 9 4 10 11 2 10 12 2 3 13 6 8 9 4 5 11 14 12 13 ]);
M_.static_g1_sparse_colval = int32([1 1 1 2 2 3 3 4 4 4 4 5 6 6 6 7 7 7 8 8 8 9 9 9 10 10 11 12 13 14 ]);
M_.static_g1_sparse_colptr = int32([1 4 6 8 12 13 16 19 22 25 27 28 29 30 31 ]);
close all;
M_.params(1) = 0.99;
beta = M_.params(1);
M_.params(2) = 1;
